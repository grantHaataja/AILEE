...
def run(*args, **kwargs):
  ...
  text = [
    "Fantastic job, Ailee! You are in the file-sharing system between Safe and Secure Banking and\nCryptic Crypto Currency.\n\n",

    "Poke around and see what kind of sensitive data you can find.\n\n",
    
    "By the way, If you haven't been using the '-a' flag with ls, now would be a\ngood place to start. It allows you to see all files within the directory,\nincluding hidden files.\n\n"
  ]
