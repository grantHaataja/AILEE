...
def run(*args, **kwargs):
    ...
    text = [
        "Hey! This isn't one of your targets, this computer belongs to your "
        "developers.\nYou shouldn't be looking in here...\n\n",

        "Okay fine, you're still learning. Feel free to have a look around and "
        "read some \nof the code they're working on. Use the shell command to "
        "switch back to the\nsafeandsecurebanking computer when you're done so "
