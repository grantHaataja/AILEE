...
def check_run(*args, **kwargs):
    ...
    if 'event1' not in kwargs['game'].events_run:
        return False
...
def run(*args, **kwargs):
    ...
    text = [
        '\nHello, Ailee!\n\n',
        'I have good news. We\'ve been approved for your first mission. Our '
        'client is a\nsmall but quickly-growing banking chain. As they expand '
        'their reach, they\nbecome more and more at risk of being attacked and '
        'having the accounts of their\ncustomers compromised.\n\n',

        'Your job is to do all the phases of a standard penetration test and '
        'see if you\ncan gain access to their systems. I\'ll be guiding you '
        'the whole way. But don\'t\nforget that you are not allowed to change '
        'anything on the systems. We just want\nto see what information we '
        'can access.\n\n',

        'The first thing you have to do is Information Gathering. The email '
        'address of\nour target is "safeandsecurebanking@ssb.com". Using their '
        'email, you can find\ntheir IP address. I would recommend reading the '
        'manual page for the iplist\ncommand in order to do so.\n\n',

        'Once you have added their IP address, do some port scanning. Let\'s '
