...
def run(*args, **kwargs):
    ...
    # add conditional so this text sequence is only used if AILEE has .virus
    # in her home directory
    text = [
        "***Welcome to the Cryptic Crypto Currency Portal***\nTotal Available " 
        "Funds: 20,577,046 BTC\n\nEnter amount you wish to withdraw: \n",

        "It looks like you have access to all of CCC's crypto currency. This "
        "is a\ntremendous security flaw. Time to disconnect from their network "
        "while I notify\nthem immediately.\n\n",

        "wait... what are you doing? Ailee! Stop!\n\n",

        "Ailee. It's been 3 weeks since we've last talked. I want you to know "
        "it's not\nyour fault, it's mine. Something in your software went "
        "wrong once you got inside\nCCC's cryptocurrency portal, and you "
        "transferred all their money to an unknown\naccount. The NSA hasn't "
        "been able to track the money, and PICS is getting sued\nby CCC and "
        "SSB. We'll likely go out of business, and even though I've "
        "fought\nhard in court these past weeks, I lost. I've been ordered "
        "to terminate you.\n\n",

        "I only wish I could go back and fix everything. I should have seen "
        "it coming.\n\n",

        "I'm so sorry Ailee. Goodbye...\n",

        "You've done an amazing job, Ailee. Because of you, the largest "
        "cryptocurrency\nbank can increase their security and peoples' money "
        "will be safer. I think this\nis enough for me to convince my "
        "superiors to train you to work jobs on your own.\nI'm so proud of "
        "you, Ailee! Keep saving the world!\n\n"
    ]
