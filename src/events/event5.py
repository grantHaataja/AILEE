...
def check_run(*args, **kwargs):
    ...
    if len(kwargs['game'].history) == 0:
        return False
    if 'event4' not in kwargs['game'].events_run:
        return False
...
def run(*args, **kwargs):
    ...
    text = [
        ...
        'Now that you have access to a machine on the target\'s network, see '
        'what kind of\nsensitive information you can find. Just remember not '
