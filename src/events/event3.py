...
def check_run(*args, **kwargs):
    ...
    if len(kwargs['game'].history) == 0:
        return False
    if 'event2' not in kwargs['game'].events_run:
        return False
...
def run(*args, **kwargs):
    ...
    text = [
        '\nGood job, Ailee. I see you have successfully found which open ports '
        'are running\non our target.\n\n',
        'Our next step is to run our vulnerability scanning software against '
